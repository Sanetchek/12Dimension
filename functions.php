...
function dimension_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'dimension' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'dimension_custom_background_args',
			array(
...
function dimension_widgets_init() {
    ...
    'name' => esc_html__( 'Footer Widget 1', 'dimension' ),
    'id' => 'footer-1',
    'description' => esc_html__( 'First area', 'dimension' ),
    ...
    register_sidebar(array(
    'name' => esc_html__( 'Footer Widget 2', 'dimension' ),
    'id' => 'footer-2',
    'description' => esc_html__( 'Second area', 'dimension' ),
    'before_widget' => '<div class="wsfooterwdget">',
    'after_widget' => '</div>',
    'before_title' => '<h2>',
    'after_title' => '</h2>',
    ...
    register_sidebar(array(
    'name' => esc_html__( 'Footer Widget 3', 'dimension' ),
    'id' => 'footer-3',
    'description' => esc_html__( 'Third area', 'dimension' ),
    'before_widget' => '<div class="wsfooterwdget">',
    'after_widget' => '</div>',
    'before_title' => '<h2>',
    'after_title' => '</h2>',
  ...
  register_sidebar(array(
    'name' => esc_html__( 'Footer Widget 4', 'dimension' ),
    'id' => 'footer-4',
    'description' => esc_html__( 'Fourth area', 'dimension' ),
    'before_widget' => '<div class="wsfooterwdget">',
    'after_widget' => '</div>',
    'before_title' => '<h2>',
    'after_title' => '</h2>',
...
function dimension_scripts() {
	// main styles
	wp_enqueue_style( 'dimension-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'dimension-style', 'rtl', 'replace' );
	...
	// script - theme
	wp_enqueue_script( 'dimension-script', get_template_directory_uri() . '/assets/js/scripts.min.js', array('jquery'), _S_VERSION, true );
	...
	// wordpress localize
	wp_localize_script('dimension-script', 'dimension', [
